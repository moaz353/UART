...
// Generated on 08/31/2026 at 22:06:15
// Library Name: uart.ndm
// Block Name: temp_route_ends
// User Label: 
// Write Command: write_verilog -include { pg_netlist unconnected_ports } /home/ICer/Mo_AZ/UART_Project/pnr/step_7_finishing/outputs/uart.pg.v
...
DFFARX1_RVT \p_data_temp_reg[7] ( .D ( n38 ) , .CLK ( clk ) , 
    .RSTB ( rst_n ) , .Q ( p_data_temp[7] ) , .QN ( SYNOPSYS_UNCONNECTED_1 ) , 
    .VDD ( VDD ) , .VSS ( VSS ) ) ;
DFFARX1_RVT \p_data_temp_reg[6] ( .D ( n37 ) , .CLK ( clk ) , 
    .RSTB ( rst_n ) , .Q ( p_data_temp[6] ) , .QN ( SYNOPSYS_UNCONNECTED_2 ) , 
    .VDD ( VDD ) , .VSS ( VSS ) ) ;
DFFARX1_RVT \p_data_temp_reg[5] ( .D ( n36 ) , .CLK ( clk ) , 
    .RSTB ( rst_n ) , .Q ( p_data_temp[5] ) , .QN ( SYNOPSYS_UNCONNECTED_3 ) , 
    .VDD ( VDD ) , .VSS ( VSS ) ) ;
DFFARX1_RVT \p_data_temp_reg[4] ( .D ( n35 ) , .CLK ( clk ) , 
    .RSTB ( rst_n ) , .Q ( p_data_temp[4] ) , .QN ( SYNOPSYS_UNCONNECTED_4 ) , 
    .VDD ( VDD ) , .VSS ( VSS ) ) ;
DFFARX1_RVT \p_data_temp_reg[3] ( .D ( n34 ) , .CLK ( clk ) , 
    .RSTB ( rst_n ) , .Q ( p_data_temp[3] ) , .QN ( SYNOPSYS_UNCONNECTED_5 ) , 
    .VDD ( VDD ) , .VSS ( VSS ) ) ;
DFFARX1_RVT \p_data_temp_reg[2] ( .D ( n33 ) , .CLK ( clk ) , 
    .RSTB ( rst_n ) , .Q ( p_data_temp[2] ) , .QN ( SYNOPSYS_UNCONNECTED_6 ) , 
    .VDD ( VDD ) , .VSS ( VSS ) ) ;
DFFARX1_RVT \p_data_temp_reg[1] ( .D ( n32 ) , .CLK ( clk ) , 
    .RSTB ( placeHFSNET_4 ) , .Q ( p_data_temp[1] ) , 
    .QN ( SYNOPSYS_UNCONNECTED_7 ) , .VDD ( VDD ) , .VSS ( VSS ) ) ;
DFFARX1_RVT \p_data_temp_reg[0] ( .D ( n31 ) , .CLK ( clk ) , 
    .RSTB ( placeHFSNET_4 ) , .Q ( p_data_temp[0] ) , 
...
DFFARX1_RVT stp_err_reg ( .D ( n2 ) , .CLK ( clk ) , .RSTB ( rst_n ) , 
    .Q ( stp_err ) , .QN ( SYNOPSYS_UNCONNECTED_1 ) , .VDD ( VDD ) , 
    .VSS ( VSS ) ) ;
...
DFFARX1_RVT str_glitch_reg ( .D ( copt_net_22 ) , .CLK ( clk ) , 
    .RSTB ( rst_n ) , .Q ( str_glitch ) , .QN ( SYNOPSYS_UNCONNECTED_1 ) , 
    .VDD ( VDD ) , .VSS ( VSS ) ) ;
...
DFFARX1_RVT calc_par_bit_reg ( .D ( n10 ) , .CLK ( clk ) , .RSTB ( rst_n ) , 
    .Q ( calc_par_bit ) , .QN ( SYNOPSYS_UNCONNECTED_1 ) , .VDD ( VDD ) , 
    .VSS ( VSS ) ) ;
...
DFFARX1_RVT ser_data_reg ( .D ( N12 ) , .CLK ( clk ) , .RSTB ( rst_n ) , 
    .Q ( ser_data ) , .QN ( SYNOPSYS_UNCONNECTED_1 ) , .VDD ( VDD ) , 
    .VSS ( VSS ) ) ;
...
DFFARX1_RVT ser_done_reg ( .D ( N17 ) , .CLK ( clk ) , .RSTB ( rst_n ) , 
    .Q ( ser_done ) , .QN ( SYNOPSYS_UNCONNECTED_2 ) , .VDD ( VDD ) , 
    .VSS ( VSS ) ) ;
...
DFFSSRX1_RVT par_bit_reg ( .D ( rst_n ) , .SETB ( VDD ) , .RSTB ( n2 ) , 
    .CLK ( clk ) , .Q ( par_bit ) , .QN ( SYNOPSYS_UNCONNECTED_1 ) , 
    .VDD ( VDD ) , .VSS ( VSS ) ) ;
...
uart_rx uart_rx_inst ( .clk ( clk ) , .rst_n ( placeZBUF_3 ) , 
    ...
    .\p_data[10] ( SYNOPSYS_UNCONNECTED_2 ) , .\p_data[9] ( rx_p_data[9] ) , 
    .\p_data[8] ( rx_p_data[8] ) , .\p_data[7] ( rx_p_data[7] ) , 
    .\p_data[6] ( rx_p_data[6] ) , .\p_data[5] ( rx_p_data[5] ) , 
    .\p_data[4] ( rx_p_data[4] ) , .\p_data[3] ( rx_p_data[3] ) , 
    .\p_data[2] ( rx_p_data[2] ) , .\p_data[1] ( rx_p_data[1] ) , 
    .placeZBUF_2 ( placeZBUF_0 ) , .VDD ( VDD ) , .VSS ( VSS ) , 
    .placeHFSNET_2 ( rx_data_valid ) ) ;
DFFARX2_RVT baud_cnt_reg_2_ ( .D ( N4 ) , .CLK ( clk ) , 
    .RSTB ( placeZBUF_3 ) , .Q ( baud_cnt[2] ) , 
    .QN ( SYNOPSYS_UNCONNECTED_3 ) , .VDD ( VDD ) , .VSS ( VSS ) ) ;
